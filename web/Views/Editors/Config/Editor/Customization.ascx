       ...
       <div class="line">
        ...
        <div id="holder_editorConfig_customization_customer" class="config_object_holder" hidden>
            ...
            <div class="line input_line">
                ...
                <input type="text" id="editorConfig_customization_customer_logo" name="editorConfig_customization_customer_logo" value="https://legacy-api.onlyoffice.com/zh/content/img/docbuilder/examples/blue_cloud.png">
            </div>
            <div class="line input_line">
                <label for="editorConfig_customization_customer_logoDark">深色Logo标志</label>
                <input type="text" id="editorConfig_customization_customer_logoDark" name="editorConfig_customization_customer_logoDark" value="https://legacy-api.onlyoffice.com/zh/content/img/docbuilder/examples/user-profile.png">
            </div>
            <div class="line input_line">
        ...
        <div id="holder_editorConfig_customization_logo" class="config_object_holder" hidden>
            <div class="line input_line">
                ...
                <input type="text" id="editorConfig_customization_logo_image" name="editorConfig_customization_logo_image" value="https://legacy-api.onlyoffice.com/zh/content/img/docbuilder/examples/blue_cloud.png">
            </div>
            <div class="line input_line">
                <label for="editorConfig_customization_logo_imageDark">深色图像</label>
                <input type="text" id="editorConfig_customization_logo_imageDark" name="editorConfig_customization_logo_imageDark" value="https://legacy-api.onlyoffice.com/zh/content/img/docbuilder/examples/user-profile.png">
            </div>
            <div class="line input_line">
...
<note>请注意，只有以下参数可用于移动编辑器：<a href="#close">close</a>、<a href="#feedback">feedback</a>、<a href="#goback">goback</a>、
<a href="# 帮助">help</a>、<a href="#logo">logo</a>、<a href="#macrosMode">宏模式</a>、<a href="#mobileForceView">mobileForceView</a>。</note>
...
<table class="table">
    ...
    "hoverMode": false
        ...
        <tr>
            ...
            <td>
                定义顶部工具栏上是否显示或隐藏<b>Complete & Submit</b>按钮。
        ...
        <tr>
            ...
            <td>
                ...
                第一个选项具有更高的优先级。
                <p></p>
                除了可用的编辑器主题外，用户还可以为应用程序界面自定义自己的<a href="https://helpcenter.onlyoffice.com/installation/docs-developer-change-theme.aspx?from=api" target="_blank">颜色主题</a>。
            </td>
            <td>string</td>
            <td>theme-dark</td>
        </tr>
