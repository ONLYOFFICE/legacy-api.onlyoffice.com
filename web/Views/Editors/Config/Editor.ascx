        ...
        <div class="config_nested_group" style="margin-bottom: 0;">
            <div id="holder_editorConfig_user" class="config_object_holder" hidden>
                ...
                <div class="line input_line">
                    ...
                    <input type="text" id="editorConfig_user_image" name="editorConfig_user_image" value="https://legacy-api.onlyoffice.com/content/img/docbuilder/examples/blue_cloud.png">
                </div>
                <div class="line input_line">
